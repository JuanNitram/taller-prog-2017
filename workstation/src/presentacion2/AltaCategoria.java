	...
	public AltaCategoria(ICtrlPropuesta iCP) {
		...
		btnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(fieldCategoria.getText().trim().isEmpty()) JOptionPane.showMessageDialog(null, "Ingrese un nombre para la categor�a", "Culturarte - Crear categor�a", JOptionPane.ERROR_MESSAGE);
				else {
					fieldCategoria.setText(fieldCategoria.getText().trim());
					crearCategoria();
					JOptionPane.showInternalMessageDialog(getParent(), "La categoría fue dada de alta correctamente","Culturarte",JOptionPane.INFORMATION_MESSAGE);
					setVisible(false);
					limpiarCampos();
				}
			}
