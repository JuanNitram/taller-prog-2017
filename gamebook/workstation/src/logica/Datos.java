...
public class Datos {
	...
	public Datos() {
		...
		cp.agregarFavorita("hrubino","Religiosamente");
		cp.agregarFavorita("hrubino","El Pimiento Indomable");
		cp.agregarFavorita("hrubino","Un día de Julio");
		cp.agregarFavorita("mbusca","Cine en el Botánico");
		cp.agregarFavorita("mbusca","El Pimiento Indomable");
		cp.agregarFavorita("mbusca","Pilsen Rock");
		cp.agregarFavorita("hectorg","Romeo y Julieta");
		cp.agregarFavorita("hectorg","El Lazarillo de Tormes");
		cp.agregarFavorita("tabarec","Religiosamente");
		cp.agregarFavorita("tabarec","Un día de Julio");
		cp.agregarFavorita("cachilas","Religiosamente");
		cp.agregarFavorita("juliob","Romeo y Julieta");
		cp.agregarFavorita("juliob","El Lazarillo de Tormes");
		cp.agregarFavorita("diegop","Cine en el Botánico");
		cp.agregarFavorita("diegop","El Lazarillo de Tormes");
		cp.agregarFavorita("kairoh","Religiosamente");
		cp.agregarFavorita("kairoh","Pilsen Rock");
		cp.agregarFavorita("losBardo","Bardo en la FING");
		cp.agregarFavorita("robinh","Cine en el Botánico");
		cp.agregarFavorita("marcelot","Religiosamente");
		cp.agregarFavorita("marcelot","El Pimiento Indomable");
		cp.agregarFavorita("novick","Religiosamente");
		cp.agregarFavorita("novick","Pilsen Rock");
		cp.agregarFavorita("sergiop","El Pimiento Indomable");
		cp.agregarFavorita("sergiop","Romeo y Julieta");
		cp.agregarFavorita("chino","Pilsen Rock");
		cp.agregarFavorita("tonyp","Pilsen Rock");
		cp.agregarFavorita("tonyp","Un día de Julio");
		cp.agregarFavorita("nicoJ","Cine en el Botánico");
		cp.agregarFavorita("juanP","Pilsen Rock");
		cp.agregarFavorita("Mengano","Religiosamente");
		cp.agregarFavorita("Mengano","Un día de Julio");
		cp.agregarFavorita("Perengano","Pilsen Rock");
		cp.agregarFavorita("Perengano","Un día de Julio");
		cp.agregarFavorita("Tiajaci","Religiosamente");
		cp.agregarFavorita("Tiajaci","El Lazarillo de Tormes");
