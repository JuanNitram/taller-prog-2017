									...
									<div class="panel-body">
										<form role="form" action="AltaUsuario" id="formUsuario"
											...
											<div class="row">
												<div class="col-xs-6 col-sm-6 col-md-6">
													<div class="form-group">
														<input type="password" name="txContrasenia" id="password"
															class="form-control input-sm" placeholder="Contraseña">
													</div>
												</div>
												<div class="col-xs-6 col-sm-6 col-md-6">
													<div class="form-group">
														<input type="password" name="txConfContrasenia"
											...
											<div class="modal-footer">
												<input type="submit" onClick="submit()" name="submit"
													value="Enviar" class="btn btn-info btn-block"> <input
													type="reset" name="reset" value="Restablecer"
